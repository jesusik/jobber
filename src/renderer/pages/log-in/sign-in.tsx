...
import { MantineProvider, Group, Stack, Select, TextInput, Text, Image, Button } from '@mantine/core';
      ...
      <div style={{margin: "20px 30px"}}>
        ...
        <Group style={{margin: "0px 100px 0 100px"}} gap="100px">
          <Stack w="450px" gap="10px">
            ...
            <Button w="150px" left="150px" radius="15px" onClick={handleSignIn}>Sign in</Button>
          </Stack>

          <Stack>
            <Text size='50px'fw={800}>Find job that suits <br/> your interests & skills</Text>
            <Text size='lg' fw={500} mt="20px">Discover opportunities that align with your passions and expertise</Text>
